...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	// Using Constructor
	@Query("Select new com.edu.SpringBootVehicleApp.entity.User(u.firstName, u.lastName) from User u where u.id = :id") // Using
																																	// Constructor
	User findUserFullNameById(@Param("id") long id);

	//@Query("Select new com.edu.SpringBootVehicleApp.entity.User(u.nationality, u.email, u.gender) from User u where u.id = :id") // Using
																																			// Constructor
 ...
 //@Query("select new com.edu.SpringBootVehicleApp.entity.User(count(id), u.vehicle_id, v.plateNumber) from User u , Vehicle v GROUP BY u.vehicle_id")
